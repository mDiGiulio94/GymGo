...
const Login = () => {
    ...
    //use state con oggetto i value dei parametri
...
//spread array con i valori di base
        ...
        if (evento.target.name === "password" || evento.target.name === "confermaPassword") {
            passwordValide()
        }
    }
            ...
            if (name === "email") {
                ...
                if (!passwordRegex.test(value)) {
                    setError((prevError) => ({
                        ...prevError,
                        [name]:
                            "Il campo password non è valido, inseriscine una corretta",
                    }));
                } else {
          ...
          <div className="container">
            ...
            <form className="registrazione" onSubmit={onSubmitF}>
              ...
              <div className="Dati">
                ...
                <div className="prova">
                  {error.cellulare && (
                    <p className="help ">{error.cellulare}</p>
                  )}
                </div>
